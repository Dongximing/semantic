...
if __name__ == "__main__":
    ...
    parser.add_argument("--start", type=int, help="start", default=12)
    ...
    if args.model == "deepseek-ai/DeepSeek-R1-Distill-Qwen-32B":
        ...
        llm = sgl.Engine(model_path=args.model, tp_size =1,
            mem_fraction_static=0.9, 
        )
    else:
        os.environ["CUDA_VISIBLE_DEVICES"] = "3" 
        llm = sgl.Engine( model_path='deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B', mem_fraction_static=0.7)
