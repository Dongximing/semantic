...
def predict(tokenizer, input_data, model,task_name):
    ...
    speculative_output = model.generate(
        [target_text], sampling_params=sampling_params, 
    )
...
if __name__ == "__main__":
    ...
    if args.model == "Qwen/QwQ-32B":
        ...
        llm = sgl.Engine( model_path="/home/original_models/DeepSeek-R1-Distill-Qwen-32B", enable_return_hidden_states=True,mem_fraction_static=0.9)
