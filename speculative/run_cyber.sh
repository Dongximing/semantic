...
python offline_sgl_spec.py  --seed 3001   --dataset math-500 --start_dataset 100 --end_dataset 500
python offline_sgl_spec.py  --seed 456   --dataset math-500 --start_dataset 100 --end_dataset 500
python offline_sgl_spec.py  --seed 321   --dataset math-500 --start_dataset 100 --end_dataset 500
