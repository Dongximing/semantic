...
def speculative_accept(qi, pi, threshold_min=0.2):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str,  help="data_dir",default='../speculative/orginal_combine_fulltraining_lable_DeepSeek-R1-Distill-32B_deepseek1.5seed_')
