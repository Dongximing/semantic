...
if __name__ == "__main__":
    ...
    parser.add_argument("--target_probe", type=str, help="target_probe",default="../probe_weight_big/valid_new_full_size_qwq_32b_aime_output_last_hidden_list_best_probe_mse")#aime_output_last_hidden_list_best_probe_mse
