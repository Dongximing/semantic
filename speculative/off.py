...
def speculative_accept(qi, pi, threshold_min=0.06):

    q_low, q_high = max(0, qi - threshold_min), min(1, qi + threshold_min)
    p_low, p_high = max(0, pi - threshold_min), min(1, pi + threshold_min)

    return not (q_high < p_low or p_high < q_low)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str,  help="data_dir",default='../speculative/combine_fulltraining_lable_DeepSeek-R1-Distill-32B_deepseek1.5seed_')
