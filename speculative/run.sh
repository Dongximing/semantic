...
python speculative_hf_decoding.py --seed 98  --dataset math-500 --start_dataset 0 --end_dataset 30
python speculative_hf_decoding.py --seed 198  --dataset math-500 --start_dataset 0 --end_dataset 30