...
python speculative_sglang_decoding.py --seed 2013   --dataset math-500 --start_dataset 100 --end_dataset 500 --data_dir /data/semantic/speculative/slg_math-500_deepseek_r132_deepseek1.5seed_
python speculative_sglang_decoding.py --seed 2025   --dataset math-500 --start_dataset 100 --end_dataset 500 --data_dir /data/semantic/speculative/slg_math-500_deepseek_r132_deepseek1.5seed_
python speculative_sglang_decoding.py --seed 1995   --dataset math-500 --start_dataset 100 --end_dataset 500 --data_dir /data/semantic/speculative/slg_math-500_deepseek_r132_deepseek1.5seed_
