...
python speculative_hf_decoding.py --seed 2024   --dataset math-500 --start_dataset 129 --end_dataset 500 --data_dir /data/semantic/speculative/speed_up_spec_result_math-500_deepseek_r132_deepseek1.5seed_  --target_probe /data/semantic/training/new_deepseekr132b_math-500_output_last_hidden_list_best_probe_mse
