...
python speculative_hf_decoding.py --seed 298  --dataset math-500 --start_dataset 243 --end_dataset 500
python speculative_hf_decoding.py --seed 198  --dataset math-500 --start_dataset 219 --end_dataset 500
