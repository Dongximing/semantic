...
python speculative_hf_decoding.py --seed 1250   --dataset aime --start_dataset 0 --end_dataset 30
python speculative_hf_decoding.py --seed 2024   --dataset aime --start_dataset 0 --end_dataset 30
