...
def speculative_decoding(target_model, target_tokenizer, speculative_model,speculative_tokenizer,problem, target_temperature,speculative_temperature,max_new_tokens,model_target_probe,model_spec_probe):
        ...
        return generated_text, try_correct_num,correct_spe_number
...
def process_file_to_json(dir_path, target_model, target_tokenizer,speculative_model, speculative_tokenizer,problem, answer,target_temperature,speculative_temperature,max_new_tokens,model_target_probe,model_spec_probe):
    ...
    end_time = time.time()
    generated_text, try_correct_num,correct_spe_number = result
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str,  help="data_dir",default='/data/semantic/speculative/spec_result_math-500')
    parser.add_argument("--start_dataset", type=int, help="the beginning of the dataset",default=200)
    parser.add_argument("--end_dataset", type=int, help="the end of the dataset",default=500)
    parser.add_argument("--target_probe", type=str, help="target_probe",default="/data/semantic/math-500_output_last_hidden_list_best_probe_mse")
