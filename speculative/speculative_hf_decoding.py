        ...
        while checking_is_finish(generated_ids,max_new_tokens,use_target):
            ...
            if not begin:
               ...
               ## small model generation
                ...
                print("checking_generated_ids[0,small_input_ids.shape[1]:]",checking_generated_ids[0,small_input_ids.shape[1]:].shape[1])
                target_tokenizer_input = target_tokenizer(speculative_real_output, return_tensors="pt")['input_ids'].to(
                    target_model.device)
                print('target_tokenizer_input',target_tokenizer_input.shape[1])
                # big model checking
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str,  help="data_dir",default='/data/semantic/speculative/spec_result_math-500_deepseek_r132_deepseek1.5seed_')
    ...
    parser.add_argument("--target_probe", type=str, help="target_probe",default="/data/semantic/training/deepseekr132b_math-500_output_last_hidden_list_best_probe_mse")#aime_output_last_hidden_list_best_probe_mse
