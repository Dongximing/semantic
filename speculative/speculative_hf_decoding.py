...
if __name__ == "__main__":
    ...
    parser.add_argument("--speculative_probe", type=str, help="speculative_probe",default="/home/shaowei/new_probe/r11.5b_math-500_output_last_hidden_list_best_probe_mse")
