...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str,  help="data_dir",default='/data/semantic/speculative/spec_reasult_aime')
    ...
    parser.add_argument("--target_probe", type=str, help="target_probe",default="/data/semantic/training/aime_output_last_hidden_list_best_probe_mse")
