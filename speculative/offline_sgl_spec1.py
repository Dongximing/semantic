...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str, help="data_dir", default='../speculative/qwq32-r1lasthidden')
    ...
    parser.add_argument("--target_probe", type=str, help="speculative_probe", default="/home/ximing/semantic/training_limo_s1/s1_valid_h100_32bqwq_math_last_hidden_state_best_probe_mse")
    parser.add_argument("--speculative_probe", type=str, help="target_probe", default="/home/ximing/semantic/speculative/weight/s1_valid_h100_1.5b_math_last_hidden_state_best_probe_mse")
    ...
    if args.dataset =="amc23":
        if args.seed == 3210:
            wrong_list = [7, 11, 12, 13, 15, 18, 20, 27, 31, 32, 35, 36]
        elif args.seed ==6540:
            wrong_list = [6, 11, 13, 18, 20, 27, 28, 31, 36, 37]
        else:
            wrong_list = [4, 6, 7, 13, 18, 20, 27, 28, 31]
    if args.dataset == "math-500":
        if args.seed == 3210:
            wrong_list = [100, 101, 103, 115, 119, 126, 136, 138, 145, 154, 155, 168, 176, 189,  214, 217, 219, 222, 232, 239, 240, 242, 264, 276, 284, 286, 295, 296, 298, 303, 306, 308, 309, 311, 324, 349, 352, 358, 369, 371, 375, 379, 381, 383, 392, 396, 400, 419, 422, 432, 456, 478, 481, 486, 490]
        elif args.seed ==6540:
            wrong_list =[100, 103, 119, 120, 128, 130, 138, 154, 156, 166, 168, 194,  210, 217, 219, 232, 236, 239, 240, 242, 264, 265, 267, 269, 271, 284, 286, 292, 294, 296, 298, 301, 306, 308, 324, 326, 340, 342, 347, 351, 369, 372, 379, 381, 383, 392, 396, 400, 401, 403, 419, 422, 425, 432,  445, 448, 456, 460, 478, 481, 483, 485, 490, 494, 497]
        else:
            wrong_list = [100, 101, 103, 107, 119, 126, 138, 147, 154, 166, 171, 189,  210, 217, 219, 222, 232, 236, 239, 240, 242, 264, 267, 284, 286, 298, 301, 306, 308, 311, 324, 327, 332, 340, 349, 351, 352, 368, 369, 377, 381, 383, 385, 392, 400, 403, 419, 421, 422, 432, 439, 454, 456, 460, 478, 481, 485, 486, 490, 491, 494]
