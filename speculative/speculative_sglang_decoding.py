...
def speculative_accept(qi, pi, threshold_min=0.75):
...
if __name__ == "__main__":
    ...
    if args.seed == 301:
        wrong_list = [101, 109, 119, 136, 150, 156, 166, 171, 198, 205, 214, 216, 217, 219, 222, 224, 236, 242, 258, 259, 261, 262, 284, 286, 298, 304, 306, 320, 323, 327, 332, 340, 357, 383, 392, 396, 400, 401, 414, 420, 437, 456, 460, 480, 486, 492, 497]
    elif args.seed == 7811:
        wrong_list = [100, 101, 102, 103, 136, 143, 145, 168, 174, 177, 194, 198, 201, 205, 217, 219, 226, 236, 254, 268, 275, 277, 284, 286, 292, 294, 298, 302, 306, 315, 322, 327, 334, 338, 340, 343, 352, 369, 383, 392, 400, 405, 412, 419, 432, 445, 456, 466, 469, 478, 486, 490, 491]
