...
if __name__ == "__main__":
    ...
    if args.seed == 301:
        wrong_list = [101, 119, 136, 150, 156, 166, 171, 198, 205, 214, 216, 217, 219, 222, 224, 236, 242, 258, 259, 261, 262, 284, 286, 298, 304, 306, 320, 323, 327, 332, 340, 357, 383, 392, 396, 400, 401, 414, 420, 437, 456, 460, 480, 486, 492, 497]
    elif args.seed == 7811:
