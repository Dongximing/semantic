...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str,  help="data_dir",default='/data/semantic/speculative/sglang_h100_spec_result_math-500_full_size_QwQ-32B_r132_deepseek1.5seed_')
    ...
    parser.add_argument("--speculative_probe", type=str, help="speculative_probe",default="/home/new_probe/s1_valid_new_deepseekr11.5b_s1_output_last_hidden_list_best_probe_mse")
