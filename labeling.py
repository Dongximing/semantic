...
def get_deberta_output(text1,text2,model,tokenizer):
    inputs = tokenizer(text1, text2, return_tensors="pt").to("cuda:4")
...
def process_file_to_pickle(json_path, out_pkl_path):
    ...
    model = AutoModelForSequenceClassification.from_pretrained(
        "microsoft/deberta-v2-xlarge-mnli").to("cuda:4")
...
if __name__ == "__main__":
    ...
    argparse.add_argument('--base_dir', type=str, default='/shared_workspace_mfs/ximing/data_s1_200_segments_science')
