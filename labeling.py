...
def inference_model_pickle(
    ...
    for number in tqdm(range(start, end)):
        ...
        json_path = os.path.join(dir_path, f'new_generations_{number}.pkl') #new_generations_
...
if __name__ == "__main__":
    ...
    argparse.add_argument('--base_dir', type=str, default='/data/semantic/training_limo_s1/data_s1_200_science')
    argparse.add_argument('--start', type=int, default=0)
    argparse.add_argument('--end', type=int, default=106)
